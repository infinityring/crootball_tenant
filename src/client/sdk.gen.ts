...
/**
 * Get owned tenants
 * Retrieves the owned tenants
 */
export const usersGetOwnedTenants = <ThrowOnError extends boolean = false>(options: Options<UsersGetOwnedTenantsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<UsersGetOwnedTenantsResponses, UsersGetOwnedTenantsErrors, ThrowOnError>({
        security: [
            {
                name: 'crootball-api-key',
                type: 'apiKey'
 ...
 */
export const usersGetOwnedTeams = <ThrowOnError extends boolean = false>(options: Options<UsersGetOwnedTeamsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<UsersGetOwnedTeamsResponses, UsersGetOwnedTeamsErrors, ThrowOnError>({
        security: [
            {
                name: 'crootball-api-key',
                type: 'apiKey'
